export default function ColorPicker({ primaryColor, setPrimaryColor, secondaryColor, setSecondaryColor, thirdColor, setThirdColor, fourthColor, setFourthColor, bnQrStyle }) {
  return (
    bnQrStyle !== "none" && (
      <div>
